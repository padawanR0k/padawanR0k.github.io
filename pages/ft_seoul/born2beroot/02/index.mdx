...
23. 새로운 유저를 만들고 해당 유저를 과제에서 필요로 하는 두 그룹에 참가시키자
    ...
    2. [debian sudo user  추가](https://m.blog.naver.com/PostView.naver?isHttpsRedirect=true&blogId=jodi999&logNo=221336259983)
        ...
        - `sudo  - {이름}` 으로 새로 만든 사용자로 전환후 `sudo whoami` 로 root 가 뜨는지 확인
            ...
            <Image width="640" height="320" src="/img/b2r.png" alt="b2r" />
    ...
    2. `sudo visudo /etc/sudoers`
        ...
        - `authfail_message`
            ...
            - ctrl+c
                ...
                <Image width="640" height="320" src="/img/b2r_1.png" alt="./img/b2r_1.png" />

        - `badpass_message`
            - sudo사용시 에러가 발생하게되면 나오는 메세지를 커스터마이징할 메세지

            <Image width="640" height="320" src="/img/b2r_2.png" alt="./img/b2r_2.png" />
                ...
                - `awk`
                    ...
                    - `$2, $3` 표현은?
                        - awk에서 매칭된 정보들을 컬럼형식으로 가져올수 있는데, 그때 사용하는 필드
                            ...
                            <Image width="640" height="320" src="/img/b2r_3.png" alt="./img/b2r_3.png" />

                            <Image width="640" height="320" src="/img/b2r_4.png" alt="./img/b2r_4.png" />
...
- 피평가자에게 어떻게 이 가상머신의 파티션들을 볼 수 있는지 물어봐라
    - `lsblk`
        ...
        <Image width="640" height="320" src="/img/b2r_5.png" alt="b2r" />
